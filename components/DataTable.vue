...
// Dummy data for productList
const productList: SalesDetails[] = [
  {
    product: {
      id: 1,
      name: 'Wireless Mouse',
...
const headers = [
  { title: 'SN', key: '123' },
  { title: 'Vendor Info', key: '123' },
  { title: 'Contact', key: '123' },
  { title: 'Email', key: '123' },
  { title: 'Created Time', key: '123', sortable: true },
