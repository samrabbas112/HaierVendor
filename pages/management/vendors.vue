...
const widgetData = ref([
  { title: 'Total Vendor', value: '21', change: 29, desc: 'Total Vendor', icon: 'tabler-users', iconColor: 'primary' },
  { title: 'Active Vendor', value: '19', change: -14, desc: 'Total Active Vendor', icon: 'tabler-user-check', iconColor: 'success' },
  { title: 'InActive Vendor', value: '2', change: 42, desc: 'Last Week Analytics', icon: 'tabler-user-search', iconColor: 'error' },
])
</script>
