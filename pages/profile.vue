...
const trimPassword = (value: string) =>
...
watch(
  ...
  () => {
    if (form.value.confirm_new_password) {
      form.value.confirm_new_password =
        form.value.confirm_new_password.trimStart();
    }
  },
  { deep: true },
);
...
function newPasswordVisibility(event) {
  isNewPasswordVisible.value = !isNewPasswordVisible.value;
  setInputCursor(event);
}

function confirmNewPasswordVisibility(event) {
  isConfirmPasswordVisible.value = !isConfirmPasswordVisible.value;
  setInputCursor(event);
}
function currentPasswordVisibility(event) {
            ...
            <VCol cols="8" sm="8">
              ...
              <VCol cols="12" sm="6">
                ...
                <AppTextField
                  ...
                  :rules="[requiredValidator, trimPassword]"
                  ...
                  "
                  @click:append-inner="currentPasswordVisibility"
                />
              </VCol>
              ...
              <VCol cols="12" sm="6">
                <AppTextField
                  ...
                  :rules="[requiredValidator, passwordValidator, trimPassword]"
                  label="New Password"
                  ...
                  "
                  @click:append-inner="newPasswordVisibility"
                />
              </VCol>
              ...
              <VCol cols="12" sm="6">
                <AppTextField
                  ...
                  :rules="[
                    requiredValidator,
                    trimPassword,
                    passwordConfirmationRule(form.new_password),
                  ]"
                  ...
                  "
                  @click:append-inner="confirmNewPasswordVisibility"
                />
              </VCol>
            </VCol>
